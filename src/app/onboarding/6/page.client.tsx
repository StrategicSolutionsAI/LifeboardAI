...
export default function OnboardingStep6Client() {
  ...
  const handleFinish = async () => {
    ...
    if (user) {
      ...
      if (error) { console.error('Failed to mark onboarding complete:', error); return }
    }
  ...
  return (
    <OnboardingLayout step={6} title="You're all set!" description="Welcome to Lifeboard AI. Your personalized dashboard is ready." onNext={handleFinish} onBack={handleBack} isLastStep={true}>
