...
export default function OnboardingStep5() {
  ...
  const connectGoogleFit = async () => {
    ...
    try {
      window.location.href = '/api/auth/googlefit?redirectUrl=/onboarding/5'
    } catch (error) {
  ...
  return (
    <OnboardingLayout
      ...
      description="Integrate with your favorite health and fitness apps to automatically sync data and get better insights."
      onNext={handleNext}
      onBack={handleBack}
    >
