...
function TaskSkeleton() {
  return (
    <li className="flex items-start gap-3 px-4 py-4 bg-white border border-[#dbd6cf] shadow-[0px_4px_16px_rgba(163,133,96,0.06)] rounded-lg">
...
export function TaskboardDashboardContent({ selectedDate, onDateChange }: TaskboardDashboardContentProps) {
  ...
  return (
    <aside
      className={`relative -mt-12 flex-shrink-0 transition-[width] duration-300 ease-in-out ${isSidebarCollapsed ? 'w-0' : 'w-[400px]'
        }`}
    >
      <button
        type="button"
        ...
        className={`absolute top-4 left-0 z-10 flex h-8 w-8 -translate-x-1/2 items-center justify-center rounded-full border border-[#dbd6cf] bg-white text-[#314158] shadow-[0px_4px_16px_rgba(163,133,96,0.06)] transition-colors duration-200 hover:bg-[rgba(183,148,106,0.08)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-warm-500`}
      >
        {isSidebarCollapsed ? <ChevronLeft size={16} /> : <ChevronRight size={16} />}
      </button>

      <div
        className={`absolute inset-y-0 right-0 w-[400px] transition-transform duration-300 ease-in-out ${isSidebarCollapsed ? 'translate-x-full pointer-events-none opacity-0' : 'translate-x-0 pointer-events-auto opacity-100'
          }`}
        aria-hidden={isSidebarCollapsed}
      >
        <div className="rounded-lg border border-[#dbd6cf] bg-white p-6 shadow-[0px_4px_16px_rgba(163,133,96,0.06)] h-full flex flex-col">
          {/* Collapse toggle */}
          <div className="flex items-center mb-4">
            <h3 className="text-sm font-medium text-[#314158]">
          ...
          {!isSidebarCollapsed && (
            <>
              {/* Week navigation */}
              <div className="flex gap-1 text-[#8e99a8] mb-4">
              ...
              <div className="flex justify-between gap-3 overflow-x-auto pb-2 mb-4">
                {getWeekDays().map((day, idx) => (
                  <button
                    ...
                    className={`flex flex-col items-center rounded-xl px-3 py-2 w-14 transition-colors ${isSameDay(day, selectedDate)
                        ? "bg-theme-primary text-white"
                        : "bg-[#faf8f5] text-[#314158] hover:bg-[rgba(183,148,106,0.08)]"
                      }`}
                  >
              ...
              {/* Task view toggle */}
              <div className="mb-4">
                <div className="flex rounded-full border border-[#dbd6cf] bg-white p-1 w-full shadow-[0px_4px_16px_rgba(163,133,96,0.06)]">
                  {["Today", "Upcoming", "Master List"].map((tab) => (
                    <button
                      key={tab}
                      onClick={() => setTaskView(tab as any)}
                      className={`flex-1 rounded-full px-4 py-1 text-sm font-semibold transition-colors ${taskView === tab
                          ? "bg-theme-primary text-white shadow"
                          : "text-theme-secondary hover:bg-[#faf8f5] hover:text-theme-primary"
                        }`}
                    >
                      {tab}
                    </button>
              ...
              <div className="flex-1 overflow-y-auto flex flex-col">
                ...
                >
                      ...
                      <Droppable droppableId="dailyTasks">
                        {(provided) => (
                          <div ref={provided.innerRef} {...provided.droppableProps} className="flex flex-col">
                            <div
                              className="flex items-center justify-between text-sm font-medium text-[#314158] mb-2 cursor-pointer select-none"
                            ...
                            <ul
                              className="space-y-3 text-sm text-[#314158] overflow-y-auto pr-1 transition-[max-height] duration-200"
                            ...
                            >
                              {error ? (
                                ...
                                <li className="text-[#8e99a8] text-center py-4">No tasks for today</li>
                              ) : (
                                  ...
                                  <Draggable key={t.id} draggableId={t.id.toString()} index={index}>
                                    {(prov) => (
                                      <li
                                        ...
                                        className="flex items-start gap-3 px-4 py-4 bg-white border border-[#dbd6cf] shadow-[0px_4px_16px_rgba(163,133,96,0.06)] rounded-lg"
                                      >
                                        <input
                                          type="checkbox"
                                          ...
                                          className={`${t.completed ? "accent-amber-600" : "accent-warm-500"} mt-0.5`}
                                        />
                                        <span className={t.completed ? "line-through text-[#8e99a8]" : ""}>{t.content}</span>
                                      </li>
                                    )}
                                  </Draggable>
                                ))
                      ...
                      {!isDailyCollapsed && (
                        <div className="mt-2 flex gap-2">
                          <input
                            ...
                            className="flex-1 rounded border border-[#dbd6cf] px-2 py-1 text-sm focus-visible:border-[#bb9e7b] focus-visible:ring-[3px] focus-visible:ring-[rgba(163,133,96,0.15)] focus:outline-none"
                          />
                          <button onClick={handleAddDailyTask} className="text-sm text-warm-600 hover:underline">
                            Add
                          </button>
                        </div>
                      )}
                        ...
                        {(provided) => (
                          ...
                          >
                            {error ? (
                              ...
                              <li className="text-[#8e99a8] text-center py-4">No upcoming tasks</li>
                            ) : (
                      ...
                      {!isOpenCollapsed && (
                        <div className="mt-2 space-y-2">
                          <input
                            ...
                            className="w-full rounded border border-[#dbd6cf] px-2 py-1 text-sm focus-visible:border-[#bb9e7b] focus-visible:ring-[3px] focus-visible:ring-[rgba(163,133,96,0.15)] focus:outline-none"
                          />
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="text-sm text-warm-600 hover:underline disabled:text-[#8e99a8] disabled:no-underline"
                            >
                              Add
                            </button>
                          </div>
                  ...
                  {taskView === "Master List" && (
                    <>
                      <div className="flex items-center justify-between text-sm font-medium text-[#314158] mb-2">
                        <div
                        ...
                        <button
                          ...
                          className="p-1 hover:bg-[rgba(183,148,106,0.08)] rounded transition-colors"
                          title="Refresh tasks"
                        >
                        ...
                        {(provided) => (
                          ...
                          >
                            {error ? (
                              ...
                              <li className="text-[#8e99a8] text-center py-4">No open tasks</li>
                            ) : (
                      ...
                      {!isOpenCollapsed && (
                        <div className="mt-2 flex gap-2">
                          <input
                            ...
                            className="flex-1 rounded border border-[#dbd6cf] px-2 py-1 text-sm focus-visible:border-[#bb9e7b] focus-visible:ring-[3px] focus-visible:ring-[rgba(163,133,96,0.15)] focus:outline-none"
                          />
                          <button onClick={handleAddOpenTask} className="text-sm text-warm-600 hover:underline">
                            Add
                          </button>
                        </div>
                      )}
                  ...
                  {taskView === "Today" && (
                    <>
                      <div
                        className="flex items-center justify-between text-sm font-medium text-[#314158] mt-4 mb-2 cursor-pointer select-none"
