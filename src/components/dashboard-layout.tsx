  ...
  const EmptyBucketState = () => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 px-8 text-center h-full">
        <div className="bg-indigo-50 p-8 rounded-full mb-6 shadow-[0px_2px_10px_0px_rgba(79,70,229,0.10)]">
        ...
        <Sheet open={isWidgetLibraryOpen} onOpenChange={setIsWidgetLibraryOpen}>
          <SheetTrigger asChild>
            <Button className="gap-2 bg-indigo-400 hover:bg-indigo-500 text-white">
    ...
    <div className="relative min-h-screen bg-violet-50 pl-20">
      ...
      <div className="relative max-w-6xl mx-auto mt-32 mb-16">
        ...
        <div className="flex z-10 -translate-y-6">
          <div className="px-6 py-2 bg-indigo-500 rounded-t-lg flex justify-center items-center">
          ...
          <div className="w-8 h-8 flex justify-center items-center bg-white rounded-t-lg ml-1">
            <div className="text-indigo-500 text-base font-bold">+</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-tr-lg rounded-b-lg shadow-sm w-full">
          ...
          <div className="flex items-center gap-8 px-8 pt-4 pb-3 border-b border-gray-100">
            <div className="text-indigo-500 text-xs font-medium border-b-2 border-indigo-500 pb-2">Overview</div>
            <div className="text-gray-400 text-xs font-medium">Trends</div>
            <div className="text-gray-400 text-xs font-medium">Logs</div>
            <div className="text-gray-400 text-xs font-medium">Settings</div>
          </div>
                ...
                <div>
                  ...
                  <div className="mb-4 border-b border-gray-100">
                    <div className="flex space-x-6">
                      <div className="text-indigo-500 text-xs font-medium border-b-2 border-indigo-500 pb-2">Weight</div>
                      <div className="text-gray-400 text-xs font-medium">Activity</div>
                      <div className="text-gray-400 text-xs font-medium">Nutrition</div>
                      <div className="text-gray-400 text-xs font-medium">Recovery</div>
                      <div className="text-gray-400 text-xs font-medium">Rest</div>
                    </div>
                  </div>
              ...
              <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-4 mb-4">
                ...
                <div className="grid grid-cols-7 gap-1 text-center">
                  {weekDays.map((d) => (
                    <div
                      key={d.toISOString()}
                      className={`text-xs py-1 rounded ${isSameDay(d, today) ? 'bg-indigo-500 text-white' : 'text-gray-900'}`}
                    >
                      {format(d, 'd')}
                    </div>
                  ))}
              ...
              <div className="bg-white rounded-lg border border-gray-100 shadow-sm p-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-start">
                    <div className="w-4 h-4 rounded-full border border-indigo-500 flex-shrink-0 mt-0.5"></div>
                    <div className="ml-2">
      ...
      <div className="absolute left-36 right-6 bottom-4 px-4 py-3 bg-white rounded-2xl shadow-[0px_2px_10px_0px_rgba(58,53,65,0.06)] flex justify-between items-center">
        <div className="flex items-center gap-4">
          <div className="p-1.5 bg-gradient-to-br from-indigo-400 to-indigo-400 rounded-[10px] flex justify-center items-center gap-2">
            <div className="w-5 h-5 text-white">
              <MessageSquare className="w-5 h-5" />
            </div>
          </div>
          <div>
            <span className="text-indigo-500 text-base font-medium font-['Circular_Std'] leading-normal">|</span>
