            ...
            <div className="space-y-4">
                    ...
                    {Object.entries(PROJECT_TEMPLATES).slice(0, 6).map(([category, templates]) => 
                      templates.slice(0, 1).map((template, index) => (
                        <button
                          ...
                          className="p-3 text-left text-sm bg-gray-50 hover:bg-gray-100 rounded-lg border border-gray-200 hover:border-gray-300 transition-colors"
                        >
                          <div className="flex items-center gap-2 mb-1">
                            {getCategoryIcon(category as ProjectCategory)}
                            <span className="font-medium text-gray-900 capitalize">{category}</span>
                          </div>
                          <div className="text-gray-600 text-xs truncate">{template}</div>
                        </button>
                      ))
                    )}
                  </div>
              ...
              {editingProject && (
                <div className="flex items-center gap-2 p-3 bg-blue-50 rounded-lg">
                  ...
                  <span className="text-sm text-blue-800">Editing: {editingProject.title}</span>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => {
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="hours" className="block text-sm font-medium text-gray-700 mb-1">Estimated Hours</label>
                  <input
                    id="hours"
                    type="number"
                    min="0"
